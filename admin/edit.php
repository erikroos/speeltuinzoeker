...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_POST["Submit"] == "Keur goed") {
		...
		if ($id == 0) {
			...
			$message = "<p>Gebruiker " . $_SESSION["user_name"] . " heeft een nieuwe speeltuin toegevoegd.</p>" . 
				"<p><a href='" . $baseUrl . "admin/edit.php?id=" . $id . "'>Controleer deze speeltuin</a></p>";
			Mail::sendMail($adminMail, "Nieuwe speeltuin", $message);
		} else {
			$_SESSION["feedback"] = "Speeltuin aanpassen gelukt!<br>
					...
					We streven ernaar dit binnen 24 uur te doen.";
			$message = "<p>Gebruiker " . $_SESSION["user_name"] . " heeft de speeltuin \"" . $name . "\" bewerkt.</p>" .
					"<p><a href='" . $baseUrl . "admin/edit.php?id=" . $id . "'>Controleer deze speeltuin</a></p>";
			Mail::sendMail($adminMail, "Bewerkte speeltuin", $message);
		}
